...
func main() {
	...
	fmt.Println("Please tell me the Shakespeare play you are interested in:")
	scanner.Scan()
	playChoice := scanner.Text()
	fmt.Println("So you are intersted in:\n" + playChoice)

	scanner = bufio.NewScanner(os.Stdin)
	fmt.Println("Please tell me the word you are interested in:")
	scanner.Scan()
	wordChoice := scanner.Text()
	fmt.Println("So you are intersted in\n" + wordChoice)
